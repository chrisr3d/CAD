...
/**
 * Classe qui va appliquer la tactique aléatoire Design Pattern : Singleton
 * 
 * @author Mathieu
 *
 */
public class TactiqueAleatoire implements TactiqueIAStrategie {
	...
	public static TactiqueAleatoire getInstance() {
		/*
		 * Ici je ne pense pas qu'il soit possible de crï¿½er deux intances
		 * en mï¿½me temps car une instance de l'algo seulement au choix de
	...
	public Case appliquerTactique(Plateau platIA, Plateau joueur) {
		...
		// pour chaque bateau, on récupére les cases bateaux pour
		// vï¿½rifier la
		// porté
